...
class UserApplicationsControllerTest < ActionController::TestCase
  ...
  test "should create user_application" do
    assert_difference('UserApplication.count') do
      post :create, user_application: { city: @user_application.city, name: @user_application.name, participant_num: @user_application.participant_num, pref: @user_application.pref, staff_id: @user_application.staff_id, tel: @user_application.tel, town: @user_application.town }
    end
  ...
  test "should update user_application" do
    patch :update, id: @user_application, user_application: { city: @user_application.city, name: @user_application.name, participant_num: @user_application.participant_num, pref: @user_application.pref, staff_id: @user_application.staff_id, tel: @user_application.tel, town: @user_application.town }
    assert_redirected_to user_application_path(assigns(:user_application))
  end
